...
# --- Clang-Tidy (Check Only) launcher ---
# Delegate lint workflow to repo-root Python scripts.
...
echo "--- Running Clang-Tidy (Check Only, Log in apps/build_tidy/build.log) ---"
"$PYTHON_BIN" "$RUNNER" tidy --app workout_calculator
