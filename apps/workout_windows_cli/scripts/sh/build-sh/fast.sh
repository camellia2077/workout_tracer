...
# --- Fast Build (No Optimizations) launcher ---
...
"$PYTHON_BIN" "$RUNNER" configure --app workout_calculator -- -D CMAKE_BUILD_TYPE=Release -D WARNING_LEVEL=NONE -D FAST_BUILD=ON
