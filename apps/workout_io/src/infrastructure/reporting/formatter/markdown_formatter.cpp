...
auto MarkdownFormatter::GroupSets(const std::vector<SetDetail>& sets)
  ...
  for (auto& group : groups) {
    ...
    group.estimated_1rm_ =
        TrainingMetricsService::EstimateOneRmEpley(group.weight_, max_reps);
  }
